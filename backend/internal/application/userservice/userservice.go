...
func (s *UserService) UpdateUserEmailVerificationStatus(email string, isEmailVerified bool) error {
	err := s.userRepo.UpdateUserEmailVerificationStatus(email, isEmailVerified)
	if err != nil {
		return err
	}
